...
/**
 * 描述：
 *     <br><b>利用工厂模式和单例模式编写线程池工具类</b><br>
 *     使用{@link Executors}创建线程池是不被允许的，因为他线程池的固定实现中，阻塞队列并没有设定边界，可能会产生难以估计的后果<br>
 *     但是使用{@link ThreadPoolExecutor}创建线程池，设置参数又比较繁琐，所以创建了该工具类。<br>
 *     内部主要分为IO密集型线程池，CPU密集型线程池以及混合型线程池<br>
 *     <ul>
 *         <li>{@link ThreadUtil#getIoIntenseTargetThreadPool()} IO密集型线程池</li>
 *         <li>{@link ThreadUtil#getCpuIntenseTargetThreadPool()}  CPU密集型线程池</li>
 *         <li>{@link ThreadUtil#getMixedTargetThreadPool()}   混合型线程池</li>
 *     </ul>
 *
 * <pre>
 * HISTORY
 ...
 *  1      2021/10/9 14:43    Bambi        Create
 * ****************************************************************************
 * </pre>
 *
 * @author Bambi
